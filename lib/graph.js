...
// Sama's OneDrive (where WCGTX Phyicians_04.08.2020 lives). Not secret.
const DRIVE_ID = process.env.MS_DRIVE_ID ||
  "b!QLQ6WmQo2U2K3HaoKvqkhO2dRqLv2NdDr2xw4QUSDIVA_vJcqMMrSJRlGbRIdOr_";
...
module.exports = { TENANT, CLIENT_ID, CLIENT_SECRET, DRIVE_ID, ROOT, GRAPH, accessToken, encPath, driveRoot, drivePath, ensureFolder };
